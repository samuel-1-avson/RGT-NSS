...
export default function InterpretabilityPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold mb-2">Mechanistic Interpretability</h1>
      ...
      {toolsInfo.data && (
        <div className="glass rounded-2xl p-6 space-y-4">
          <h2 className="text-lg font-semibold">Interpretability Toolkit</h2>
          <div className="grid grid-cols-2 gap-4">
            {((toolsInfo.data as any).tools || []).map((t: any) => (
              <div key={t.name} className="bg-background rounded-xl p-4 space-y-1">
                ...
                <p className="text-xs"><span className="text-green-500">Use case:</span> {t.use_case}</p>
              </div>
            ))}
          </div>
        </div>
