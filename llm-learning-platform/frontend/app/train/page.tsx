    ...
    <main className="min-h-screen bg-slate-950 text-white flex items-center justify-center">
      <div className="text-center px-6">
        <motion.div
          ...
          className="inline-flex items-center justify-center w-24 h-24 rounded-3xl bg-emerald-500/10 mb-8"
        >
        ...
        >
          Train your models with real-time metrics and visualizations. 
          Coming soon!
        </motion.p>
